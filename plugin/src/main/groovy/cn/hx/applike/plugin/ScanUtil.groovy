...
class ScanUtil {
    ...
    static final PROXY_CLASS_PREFIX = "AppLike\$\$"
    static final PROXY_CLASS_SUFFIX = "\$\$Proxy.class"
    static final PROXY_CLASS_PACKAGE_NAME = "cn/hx/applike/proxy"

    static final REGISTER_CLASS_FILE_NAME = "cn/hx/applike/api/AppLikeManager.class"

    //包含生命周期管理初始化类的文件，及包含 com.pycredit.api.AppLikeManager 类的class文件或者jar文件
